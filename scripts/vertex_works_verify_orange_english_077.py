...
checks = [
    ...
    emit("ENGLISH_LOCK_PRESENT", 'vertexWorksEnglishLock077' in index),
...
if not all(checks):
    raise SystemExit("VERTEX_WORKS_ORANGE_ENGLISH_077_VERIFY FAIL")

print("VERTEX_WORKS_ORANGE_ENGLISH_077_VERIFY PASS")
