...
backup = ROOT / "MIGRATION_BACKUPS" / "UI_ORANGE_ENGLISH_077" / stamp
...
safe_print("VERTEX WORKS ORANGE WORKSPACE / ENGLISH LOCK PYCOMPAT 000077")
...
if 'id="vertexWorksEnglishLock077"' not in index:
...
try:
    write_text_lf(INDEX, index)
    write_text_lf(ORANGE, ORANGE_CSS)
    ...
    static_checks = {
        ...
        "ENGLISH_LOCK_PRESENT": 'vertexWorksEnglishLock077' in check,
    ...
    current["ui_phase"] = "ORANGE_WORKSPACE_ENGLISH_LOCK_000077"
    ...
    safe_print("VERTEX_WORKS_ORANGE_ENGLISH_077 PASS")
